package com.allernutri.app.ui.auth

import android.app.Activity
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.allernutri.app.data.repository.AuthRepository
import com.allernutri.app.data.repository.AuthResult
import com.allernutri.app.data.repository.SessionRepository
...
class LoginViewModel @Inject constructor(
    ...
    fun signInDemo(onSuccess: () -> Unit) {
        viewModelScope.launch {
            ...
            session.saveSession("demo", "demo@allernutri.app", "demo-token")
