package com.allernutri.app.ui.export
...
import com.allernutri.app.util.PdfExporter
...
class ExportViewModel @Inject constructor(
    ...
    fun exportCsv() = viewModelScope.launch {
        ...
        try {
            val datei = File(ctx.cacheDir, "allernutri_symptome_export.csv")
    ...
    fun exportBackup() = viewModelScope.launch {
        ...
        try {
            ...
            val backup = File(ctx.cacheDir, "allernutri_backup_${LocalDate.now()}.db")
