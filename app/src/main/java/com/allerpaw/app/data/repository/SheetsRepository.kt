...
import com.allerpaw.app.data.remote.SheetsApiClient
import com.allerpaw.app.data.remote.SheetsColumnMapper
...
data class SheetsImportPreview(
    ...
    val unmapped:    List<com.allerpaw.app.data.remote.ColumnDef> = emptyList(),
