...
data class RechnerUiState(
    ...
    // Rezept-Tabs
    val rezepte: List<com.allerpaw.app.data.local.entity.RezeptEntity> = emptyList(),
    val selectedRezeptId: Long?          = null,
    val aktuellerTab: RechnerTab         = RechnerTab.REZEPTE,
    val umstellungsplan: List<UmstellungsTag>? = null,
    val editRezept: com.allerpaw.app.data.local.entity.RezeptEntity? = null
)
...
class RechnerViewModel @Inject constructor(
    ...
    fun newRezept() = _state.update {
        it.copy(editRezept = com.allerpaw.app.data.local.entity.RezeptEntity(
    ...
    fun saveRezept(
        ...
        zutaten: List<com.allerpaw.app.data.local.entity.RezeptZutatEntity>
    ) = viewModelScope.launch {
